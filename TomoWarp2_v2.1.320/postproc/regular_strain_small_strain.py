...
def regular_strain_small_strain( positions, displacements, calculateConnectivity=False  ):
  ...
  logging.log.info("regular_strain_small_strain: Calculating strains in Small Strain framework...")
  ...
  logging.log.info("regular_strain_small_strain(): strain calculation done.")
